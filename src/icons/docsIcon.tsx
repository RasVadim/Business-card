...
export const DocsIcon: FC<PropsType> = ({
  size = '20',
  color = '#9DB2CE',
  ...
  return isActive ? (
    ...
    >
      <defs>
        <mask id="docsIconMask" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
      ...
      <rect width="24" height="24" fill={secondaryColor} mask="url(#docsIconMask)" />
    </svg>
  ) : (
    <svg
      width={size}
